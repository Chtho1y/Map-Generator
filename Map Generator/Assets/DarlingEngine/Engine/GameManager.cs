...
using DarlingEngine.Engine.Lua;
using UnityEngine;
...
namespace DarlingEngine.Engine
{
	public class GameManager : MonoSingleton<GameManager>
	{
		...
		protected override void OnSingletonAwake()
		{
			...
			GameUtil.GetOrAddComponent<ExceptionCatcher>(this.gameObject);
		...
		public void LoadScene(string sceneName, bool fromBundle = false, Action onLoaded = null, Action<float> onLoading = null)
		{
			if (fromBundle)
			{
				BundleManager.Instance.LoadAllDependencies("Scene");
				BundleManager.Instance.LoadBundle("Scene");
			}
